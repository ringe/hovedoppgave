INSERT INTO `roles` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES (1, 'Ansatt', 'Vanlig ansatt', '2014-04-14', '2014-04-14');
INSERT INTO `roles` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES (2, 'Formann', 'Formann', '2014-04-14', '2014-04-14');
INSERT INTO `roles` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES (3, 'Administrator', 'Bruker med fulle rettigheter', '2014-04-14', '2014-04-14');
...
INSERT INTO `groups` (`id`, `name`, `created_at`, `updated_at`) VALUES (1, 'Administratorer', '2014-04-14', '2014-04-14');
